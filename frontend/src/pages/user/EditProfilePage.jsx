...
const EditProfilePage = () => {
  ...
  return (
    <>
      <Helmet><title>Edit Profile — ByteNest</title></Helmet>
      <div className="container-custom py-8">
        <h1 className="section-title mb-6">User Account</h1>

        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <aside className="card p-4 h-fit space-y-1">
            <Link to="/profile" className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium bg-primary-55 text-primary-600 dark:text-primary-400">
          ...
          <div className="md:col-span-3 card p-6">
            <h2 className="font-display font-bold text-xl border-b pb-4 mb-6">Edit Profile</h2>
